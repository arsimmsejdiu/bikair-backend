...
export const handler = async (event: APIGatewayRequestAuthorizerEventV2 | APIGatewayRequestAuthorizerEvent) => {
    ...
    if ((typeof apiKey === "undefined" || apiKey === null) && event.queryStringParameters) {
    ...
    if (typeof apiKey === "undefined"
        ...
        || origin === null
        || (origin !== APP_ORIGINS.ADMIN_APP && origin !== APP_ORIGINS.TECH_APP)) {
    ...
    const verifiedToken = verifyToken(bearerToken, JWT_SECRET_ADMIN);
